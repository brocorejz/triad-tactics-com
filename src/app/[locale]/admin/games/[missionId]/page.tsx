...
import AdminGameMissionPage from '@/features/games/ui/AdminGameMissionPage';
...
export default async function AdminGameMissionGatePage({ params }: { params: Promise<{ locale: string }> }) {
